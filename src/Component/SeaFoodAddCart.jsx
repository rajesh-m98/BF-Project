            ...
            <div className="container mt-2 mb-3">
                <div className="row">
                    <div className="col-md-12 d-flex">
                        ...
                        <Link to='/SeaFood.jsx' className="text-decoration-none text-dark mx-1">SEA FOOD <FontAwesomeIcon icon={faAngleRight} className="mx-1" style={{ fontSize: '12px' }}></FontAwesomeIcon></Link>
                        <Link to='/SeaFoodAddCart.jsx' className="text-decoration-none text-dark mx-1">SEA FOOD ADD CART</Link>
                    </div>
                </div>
            </div>
