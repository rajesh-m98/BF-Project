            ...
            <div class="container">
                <div aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><Link className="text-decoration-none text-dark" to='/chicken.jsx'>CHICKEN</Link></li>
                        <li class="breadcrumb-item active" aria-current="page"><Link className="text-decoration-none text-dark">CHICKEN CURRY (WITH SKIN)</Link></li>
                        ...
                        <div className="modal-body" >
                            <table className="table text-center" id={styles.extra}>
                                <tr className="bg-light p-2">
                                    <td> <img src={Chicku1} className={`${styles.extraimg}`} alt="" /> </td>
                                    <td> Chicken Wings </td>
                                    <td> ₹400 </td>
                    ...
                    <Slider {...settings} className="mt-4">
                        <div className={`card shadow ${styles.card} border-0`}>
                            <div className="vesitable-img" style={{ width: '100%' }}>
                                <img src={Chicku1} className="img-fluid w-100 rounded-top" alt="" />
                            </div>
                        ...
                        <div className={`card shadow ${styles.card}`}>
                            <div className="vesitable-img" style={{ width: '100%' }}>
                                <img src={Chicku2} className="img-fluid w-100 rounded-top" alt="" />
                            </div>
                            <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                            <div className="p-4 pb-0 rounded-bottom">
                        ...
                        <div className={`card shadow ${styles.card}`}>
                            <div className="vesitable-img" style={{ width: '100%' }}>
                                <img src={Chicku3} className="img-fluid w-100 rounded-top" alt="" />
                            </div>
                            <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                            <div className="p-4 pb-0 rounded-bottom">
                        ...
                        <div className={`card shadow ${styles.card}`}>
                            <div className="vesitable-img" style={{ width: '100%' }}>
                                <img src={Chicku4} className="img-fluid w-100 rounded-top" alt="" />
                            </div>
                            <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                            <div className="p-4 pb-0 rounded-bottom">
                        ...
                        <div className={`card shadow ${styles.card}`}>
                            <div className="vesitable-img" style={{ width: '100%' }}>
                                <img src={Chicku5} className="img-fluid w-100 rounded-top" alt="" />
                            </div>
                            <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                            <div className="p-4 pb-0 rounded-bottom">
                        ...
                        <div className={`card shadow ${styles.card}`}>
                            <div className="vesitable-img" style={{ width: '100%' }}>
                                <img src={Chicku6} className="img-fluid w-100 rounded-top" alt="" />
                            </div>
                            <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                            <div className="p-4 pb-0 rounded-bottom">
                        ...
                        <div className={`card shadow ${styles.card}`}>
                            <div className="vesitable-img" style={{ width: '100%' }}>
                                <img src={Chicku7} className="img-fluid w-100 rounded-top bg-light" alt="" />
                            </div>
                            <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                            <div className="p-4 pb-0 rounded-bottom">
                        ...
                        <div className={`card shadow ${styles.card}`}>
                            <div className="vesitable-img" style={{ width: '100%' }}>
                                <img src={Chicku8} className="img-fluid w-100 rounded-top" alt="" />
                            </div>
                            <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                            <div className="p-4 pb-0 rounded-bottom">
                        ...
                        <div className={`card shadow ${styles.card}`}>
                            <div className="vesitable-img" style={{ width: '100%' }}>
                                <img src={Chicku9} className="img-fluid w-100 rounded-top" alt="" />
                            </div>
                            <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                            <div className="p-4 pb-0 rounded-bottom">
                        ...
                        <div className={`card shadow ${styles.card}`}>
                            <div className="vesitable-img" style={{ width: '100%' }}>
                                <img src={Chicku10} className="img-fluid w-100 rounded-top" alt="" />
                            </div>
                            <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                            <div className="p-4 pb-0 rounded-bottom">
                                <h6 id="product-title1">With Tail | Deveined | Large Sized</h6>
...
export default ChickenCustomize;