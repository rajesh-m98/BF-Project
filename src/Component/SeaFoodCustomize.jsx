        ...
        <>
            ...
            <div class="container">
                <div aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><Link className="text-decoration-none text-dark" to='/SeaFood.jsx'>SEA FOOD</Link></li>
                        <li class="breadcrumb-item active" aria-current="page"><Link className="text-decoration-none text-dark">FISH SALMAON </Link></li>
            ...
            <div className="container" id={styles.customizeimg}>
                <div className="row">
                    ...
                    <div className="col-lg-5">
                        <h6 className="fw-semibold mb-1" id={styles.cart_item}>Salmon Fish - Mild Flavour</h6>
                        ...
                        <div className="modal-body" >
                            <table className="table text-center" id={styles.extra}>
                                <tr className="bg-light p-2">
                                    <td> <img src={F1} className={`${styles.extraimg}`} alt="" /> </td>
                                    <td> Chicken Wings </td>
                                    <td> ₹400 </td>
                    ...
                    <Slider {...settings} className="mt-4">
                        <div className={`card shadow ${styles.card} border-0`}>
                            <div className="vesitable-img" style={{ width: '100%' }}>
                                <img src={F1} className="img-fluid w-100 rounded-top" alt="" />
                            </div>
                        ...
                        <div className={`card shadow ${styles.card}`}>
                            <div className="vesitable-img" style={{ width: '100%' }}>
                                <img src={F2} className="img-fluid w-100 rounded-top" alt="" />
                            </div>
                            <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                            <div className="p-4 pb-0 rounded-bottom">
                        ...
                        <div className={`card shadow ${styles.card}`}>
                            <div className="vesitable-img" style={{ width: '100%' }}>
                                <img src={F3} className="img-fluid w-100 rounded-top" alt="" />
                            </div>
                            <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                            <div className="p-4 pb-0 rounded-bottom">
                        ...
                        <div className={`card shadow ${styles.card}`}>
                            <div className="vesitable-img" style={{ width: '100%' }}>
                                <img src={F4} className="img-fluid w-100 rounded-top" alt="" />
                            </div>
                            <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                            <div className="p-4 pb-0 rounded-bottom">
                        ...
                        <div className={`card shadow ${styles.card}`}>
                            <div className="vesitable-img" style={{ width: '100%' }}>
                                <img src={F5} className="img-fluid w-100 rounded-top" alt="" />
                            </div>
                            <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                            <div className="p-4 pb-0 rounded-bottom">
                        ...
                        <div className={`card shadow ${styles.card}`}>
                            <div className="vesitable-img" style={{ width: '100%' }}>
                                <img src={F6} className="img-fluid w-100 rounded-top" alt="" />
                            </div>
                            <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                            <div className="p-4 pb-0 rounded-bottom">
                        ...
                        <div className={`card shadow ${styles.card}`}>
                            <div className="vesitable-img" style={{ width: '100%' }}>
                                <img src={F7} className="img-fluid w-100 rounded-top bg-light" alt="" />
                            </div>
                            <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                            <div className="p-4 pb-0 rounded-bottom">
                        ...
                        <div className={`card shadow ${styles.card}`}>
                            <div className="vesitable-img" style={{ width: '100%' }}>
                                <img src={F8} className="img-fluid w-100 rounded-top" alt="" />
                            </div>
                            <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                            <div className="p-4 pb-0 rounded-bottom">
                        ...
                        <div className={`card shadow ${styles.card}`}>
                            <div className="vesitable-img" style={{ width: '100%' }}>
                                <img src={F9} className="img-fluid w-100 rounded-top" alt="" />
                            </div>
                            <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                            <div className="p-4 pb-0 rounded-bottom">
                        ...
                        <div className={`card shadow ${styles.card}`}>
                            <div className="vesitable-img" style={{ width: '100%' }}>
                                <img src={F10} className="img-fluid w-100 rounded-top" alt="" />
                            </div>
                            <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                            <div className="p-4 pb-0 rounded-bottom">
                                <h6 id="product-title1">With Tail | Deveined | Large Sized</h6>
...
export default SeaFoodCustomize;