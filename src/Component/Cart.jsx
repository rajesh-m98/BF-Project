...
const Cart = () => {
    ...
    return (
        <>
            ...
            <div className="container" id={styles.carttable}>
                <div className="row">
                    <table className="table text-center">
                        ...
                        <tr>
                            ...
                            <td><img src={Chicken1} alt="" className="w-50 h-50 rounded" /></td>
                            <td><input type="number" className="form-control border-0 rounded text-center bg-warning p-3 mx-2" style={{height:'10px', width:'90px'}} value={quantity} onChange={handleQuantityChange} /></td>
                            <td><button className="bg-warning btn w-50 text-center"><input type="text" className="border-0 w-75 bg-warning fw-bold text-center" value={totalPrice} readOnly style={{fontSize:'13px'}} /></button></td>
                            <td><input type="checkbox" className="form-check-input bg-warning border-dark w-25" value="remove" name="remove" onChange={handleCheckboxChange} /></td>
                            <td>
                                <button className="btn bg-warning w-50 text-white" >UPDATE</button>
                                <button className="btn bg-warning w-50 text-white mx-1 mt-2">REMOVE</button>
                            </td>
                        </tr>
                    </table>
                </div>
