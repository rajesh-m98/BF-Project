...
import C3 from "./images/coldcut/c3.jpg";
import C4 from "./images/coldcut/c4.jpg";
import C5 from "./images/coldcut/c5.jpg";
import C6 from "./images/coldcut/c6.jpg";
import C7 from "./images/coldcut/c7.jpg";
import C8 from "./images/coldcut/c9.jpg";
import C9 from "./images/coldcut/c8.jpg";
...
const ColdCutCustomize = () => {
    ...
    return (
        <>
                ...
                <div className="row">
                    <div className="col-lg-5">
                        <div className="border rounded">
                            <a href="#">
                                <img src={C1} className="img-responsive rounded w-100" alt="Image" id={styles.cart_image} />
                            </a>
                        </div>
                    </div>
                    <div className="col-lg-5">
            ...
            {/* Modal  */}
            <div className="modal fade" style={{ fontSize: '14px' }} id="exampleModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h6 className="modal-title text-center mx-5 px-4 fw-bold">
                                Accomplishments For Coldcuts(Optional)
                            </h6>
                ...
                <Slider {...settings} className={`container ${styles.slickslider}`}>
                    <div className={`card shadow ${styles.card}`}>
                        <div className="vesitable-img" style={{ width: '100%' }}>
                            <img src={C2} className="img-fluid w-100 rounded-top" alt="" />
                        </div>
                        ...
                        <div className="p-4 pb-0 rounded-bottom">
                            <h6 id="product-title1">Classic Chicken Salami</h6>
                            <p>Meaty & juicy, apt for cold sandwiches.</p>
                    ...
                    <div className={`card shadow ${styles.card}`}>
                        <div className="vesitable-img" style={{ width: '100%' }}>
                            <img src={C3} className="img-fluid w-100 rounded-top" alt="" />
                        </div>
                        <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                        <div className="p-4 pb-0 rounded-bottom">
                            <h6 id="product-title1">Spicy Chicken Salami</h6>
                            <p>Meaty & juicy, apt for cold sandwiches.</p>
                            <div className="d-flex justify-content-between flex-lg-wrap">
                    ...
                    <div className={`card shadow ${styles.card}`}>
                        <div className="vesitable-img" style={{ width: '100%' }}>
                            <img src={C4} className="img-fluid w-100 rounded-top" alt="" />
                        </div>
                        <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                        <div className="p-4 pb-0 rounded-bottom">
                            <h6 id="product-title1">Smoked Chicken Pepperoni</h6>
                            <p>Meaty & juicy, apt for cold sandwiches.</p>
                            <div className="d-flex justify-content-between flex-lg-wrap">
                    ...
                    <div className={`card shadow ${styles.card}`}>
                        <div className="vesitable-img" style={{ width: '100%' }}>
                            <img src={C5} className="img-fluid w-100 rounded-top" alt="" />
                        </div>
                        <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                        <div className="p-4 pb-0 rounded-bottom">
                            <h6 id="product-title1">Spicy Chicken Sausage
                            </h6>
                            <p>Meaty & juicy, apt for cold sandwiches.</p>
                            <div className="d-flex justify-content-between flex-lg-wrap">
                                <p className="text-dark fs-5 fw-bold">₹169</p>
                    ...
                    <div className={`card shadow ${styles.card}`}>
                        <div className="vesitable-img" style={{ width: '100%' }}>
                            <img src={C6} className="img-fluid w-100 rounded-top" alt="" />
                        </div>
                        <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                        <div className="p-4 pb-0 rounded-bottom">
                            <h6 id="product-title1">Chicken Pepper Sausage  </h6>
                            <p>Meaty & juicy, apt for cold sandwiches.</p>
                            <div className="d-flex justify-content-between flex-lg-wrap">
                                <p className="text-dark fs-5 fw-bold">₹169</p>
                                <a href="#" className="btn btn-shop btn border border-secondary rounded-pill px-3 py-1 mb-4 text-dark"> Add to cart</a>
                    ...
                    <div className={`card shadow ${styles.card}`}>
                        <div className="vesitable-img" style={{ width: '100%' }}>
                            <img src={C7} className="img-fluid w-100 rounded-top" alt="" />
                        </div>
                        <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                        <div className="p-4 pb-0 rounded-bottom">
                            <h6 id="product-title1">Chicken Nuremberger</h6>
                            <p>Meaty & juicy, apt for cold sandwiches.</p>
                            <div className="d-flex justify-content-between flex-lg-wrap">
                                <p className="text-dark fs-5 fw-bold">₹169</p>
                                <a href="#" className="btn btn-shop btn border border-secondary rounded-pill px-3 py-1 mb-4 text-dark"> Add to cart</a>
                    ...
                    <div className={`card shadow ${styles.card}`}>
                        <div className="vesitable-img" style={{ width: '100%' }}>
                            <img src={C8} className="img-fluid w-100 rounded-top bg-light" alt="" />
                        </div>
                        <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                        <div className="p-4 pb-0 rounded-bottom">
                            <h6 id="product-title1">Cheese & Jalapeno Chicken Sausage</h6>
                            <p>Meaty & juicy, apt for cold sandwiches.</p>
                            <div className="d-flex justify-content-between flex-lg-wrap">
                    ...
                    <div className={`card shadow ${styles.card}`}>
                        <div className="vesitable-img" style={{ width: '100%' }}>
                            <img src={C9} className="img-fluid w-100 rounded-top" alt="" />
                        </div>
                        <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                        <div className="p-4 pb-0 rounded-bottom">
                            <h6 id="product-title1">Smoked Chicken Loaf</h6>
                            <p>Meaty & juicy, apt for cold sandwiches. </p>
                            <div className="d-flex justify-content-between flex-lg-wrap">
                    ...
                    <div className={`card shadow ${styles.card}`}>
                        <div className="vesitable-img" style={{ width: '100%' }}>
                            <img src={C1} className="img-fluid w-100 rounded-top" alt="" />
                        </div>
                        <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                        <div className="p-4 pb-0 rounded-bottom">
                            <h6 id="product-title1">Chicken Breakfast Sausage</h6>
                            <p> Meaty & juicy, apt for cold sandwiches.</p>
                            <div className="d-flex justify-content-between flex-lg-wrap">
                    ...
                    <div className={`card shadow ${styles.card}`}>
                        <div className="vesitable-img" style={{ width: '100%' }}>
                            <img src={C5} className="img-fluid w-100 rounded-top bg-light" alt="" />
                        </div>
                        <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                        <div className="p-4 pb-0 rounded-bottom">
                            <h6 id="product-title1">Spicy Chicken Sausage</h6>
                            <p>Meaty & juicy, apt for cold sandwiches.</p>
                            <div className="d-flex justify-content-between flex-lg-wrap">
                                <p className="text-dark fs-5 fw-bold">₹355</p>
                                <a href="#" className="btn btn-shop btn border border-secondary rounded-pill px-3 py-1 mb-4 text-dark"> Add to cart</a>
                    ...
                    <div className={`card shadow ${styles.card}`}>
                        <div className="vesitable-img" style={{ width: '100%' }}>
                            <img src={C8} className="img-fluid w-100 rounded-top" alt="" />
                        </div>
                        <div className=" btn btn-success text-white bg-offer px-3 py-1 rounded position-absolute" style={{ top: '10px', right: '10px' }}>30% Protein</div>
                        <div className="p-4 pb-0 rounded-bottom">
                            <h6 id="product-title1">Cheese & Jalapeno Chicken Sausage</h6>
...
export default ColdCutCustomize;
