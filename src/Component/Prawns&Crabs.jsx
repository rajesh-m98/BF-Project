            ...
            <div className="container mt-2">
                <div className="row">
                    <div className="col-md-12 d-flex">
                        ...
                        <Link to='/Prawns.jsx' className="text-decoration-none text-dark mx-1">PRAWNS AND CRABS</Link>
                    </div>
                </div>
            </div>
                ...
                <div className="row mt-3">
                    <div className="col-md-3" id={styles.card}>
                        ...
                        <div className="card-body">
                            ...
                            <div className="mt-2">
                                <Link to='/PrawnsCustomize.jsx' id={styles.button} className="btn text-white col-md-4">Customize</Link>
                    ...
                    <div className="col-md-3" id={styles.card}>
                        ...
                        <div className="card-body">
                            ...
                            <div className="mt-2">
                                <Link to='/PrawnsAddCart.jsx' id={styles.button} className="btn text-white col-md-4">Add Cart</Link>
                                <a href="chickenaddcart.php?product_id=29" id={styles.button} className="btn text-white mx-3 col-md-5">View More</a>
                            </div>
                        </div>
                    </div>
