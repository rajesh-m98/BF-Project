                ...
                <div className="row mt-3">
                    <div className="col-md-3" id={styles.card}>
                        ...
                        <div className="card-body">
                            ...
                            <div className="mt-2">
                                <Link to='/MuttonCustomize.jsx' id={styles.button} className="btn text-white col-md-4">Customize</Link>
                    ...
                    <div className="col-md-3" id={styles.card}>
                        ...
                        <div className="card-body">
                            ...
                            <div className="mt-2">
                                <Link to='/MuttonAddCart.jsx' id={styles.button} className="btn text-white col-md-4">ADD CART</Link>
                                <a href="chickenaddcart.php?product_id=29" id={styles.button} className="btn text-white mx-3 col-md-5">VIEW MORE</a>
                            </div>
                        </div>
                    </div>
