            ...
            <div className="container mt-2 mb-3">
                <div className="row">
                    <div className="col-md-12 d-flex">
                        ...
                        <Link to='/ReadyToCook.jsx' className="text-decoration-none text-dark mx-1">READY TO COOK <FontAwesomeIcon icon={faAngleRight} className="mx-1" style={{ fontSize: '12px' }}></FontAwesomeIcon></Link>
                        <Link to='/ReadyToCookAddCart.jsx' className="text-decoration-none text-dark mx-1">READY TO COOK ADD CART</Link>
                    </div>
                </div>
            </div>
...
export default ReadyToCookAddCart;